...
/**
 * fwstructmatch question definition class. Based on the shortanswer type.
 *
 * @package    qtype
...
/**
 * Represents a fwstructmatch question.
 *
 * @copyright  2013 Fredrik Wallner, 2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_fwstructmatch_question extends question_graded_by_strategy
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseenterananswer', 'qtype_fwstructmatch');
    }
    ...
    public function compareinchis($answer, $response, $considerstereo) {
        //        if(considerstereo) {
            $correctanswer = $answer;
            $checkanswer = $response;
/*        }
        else {
            $correctanswer = preg_replace("!/[tb][0-9?+-,]+(/m[0-9]+)?(/s[0-9]+)!", "", $answer->answer);
            $checkanswer = preg_replace("!/[tb][0-9?+-,]+(/m[0-9]+)?(/s[0-9]+)!", "", $response['answer']);
        }
*/        return $correctanswer == $checkanswer;
    ...
    public function compare_response_with_answer(array $response, question_answer $answer) {
        ...
        return $this->compareinchis($answer->answer, $this->mol2inchi($response['answer']), true);
    }

    public function mol2inchi($molfile) {
        ...
        $inchi = '';
        $process = proc_open('/usr/local/bin/obabel -imol -oinchi', $descriptorspec, $pipes);
